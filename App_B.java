...
class App_B {
    ...
    public static void main(String[] a) {
        ...
        PassengerGenerator.MAX_SIZE = Integer.MAX_VALUE;
        ...
        PassengerGenerator.queue2 = queue1;
        PassengerGenerator.queue3 = queue1;
        ...
        while (current_time <= simualation_time) {
            ...
            count_waiting[current_time] = queue1.getSize();
        ...
        double avg_waiting_time = avg_waiting_passengers / lambda;
        double avg_response_time = avg_waiting_time + 1 / mu;
        double avg_passenger_system = avg_response_time * (lambda);
